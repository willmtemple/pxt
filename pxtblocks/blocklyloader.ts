...
namespace pxt.blocks {
    ...
    function initBlock(block: Blockly.Block, info: pxtc.BlocksInfo, fn: pxtc.SymbolInfo, attrNames: Map<BlockParameter>) {
        ...
        if (pxt.shell.isBlocksV2()) {
            block.setColour(getColour(color), getColour(Blockly.PXTUtils.fadeColour(color as string, 0.5, true)) as string, getColour(Blockly.PXTUtils.fadeColour(color as string, 0.5, false)) as string);
            switch (fn.retType) {
